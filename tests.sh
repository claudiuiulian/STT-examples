...
get_python_wheel_url()
{
  ...
  echo "$(get_python_pkg_url "${pyver_pkg}" "${py_unicode_type}" "aeiou" https://community-tc.services.mozilla.com/api/queue/v1/task/${DEP_TASK_ID}/artifacts/public)"
}

get_npm_package_url()
{
  echo "https://community-tc.services.mozilla.com/api/queue/v1/task/${DEP_TASK_ID}/artifacts/public/aeiou-${DS_VERSION}.tgz"
}
